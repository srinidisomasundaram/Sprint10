Feature: Testing an Dometic LMC application
  ...
  @First1 @sanity1
  Scenario: Empty Email and Enter the password and verify password(Spanish Language)
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Enter the Email and Empty password and verify password(Spanish Language)
  ...
  @sanity1
  Scenario: Enter Valid email valid password and empty verify password(Spanish Language)
    Then I enter Email in Signup Page
    Then I enter Password in Signup Page
  ...
  @sanity1
  Scenario: Enter inValid email, password and valid verify password(Spanish Language)
  ...
  @sanity1
  Scenario: Enter Valid email, invalid password and valid verify password(Spanish Language)
    Then I enter Email in Signup Page
  ...
  @sanity1
  Scenario: Enter Valid email, password and invalid verify password(Spanish Language)
    Then I enter Email in Signup Page
    Then I enter Password in Signup Page

...
public class Constant_settings {
    ...
    public static final String Logout_button = "com.dometicapp:id/sidemenu-logout-button";
    public static final String edit_profile = "com.dometicapp:id/sidemenu-viewEditButtonText";

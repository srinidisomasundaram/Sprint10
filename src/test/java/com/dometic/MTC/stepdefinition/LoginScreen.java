...
public class LoginScreen extends Baseclass {
    ...
    public void iEnterAnEmailOnboardedWithSDBAndMarine() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I enter an email onboarded with SDB and marine");
        //Taponbutton(login_obj.Login_Email_Xpath);
        TaponbuttonaccessabilityID(login_obj.Login_Email);
        Thread.sleep(1000);
        cleartext(login_obj.Login_Email_Xpath);
        //entertext(login_obj.invaliduser1,login_obj.Login_Email_Xpath);
        entertextaccessabilityId(login_obj.SDB_Marine_user,login_obj.Login_Email);
        driver.executeScript("mobile: performEditorAction", ImmutableMap.of("action", "search"));
    ...
    public void iEnterValidPassword() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I enter Valid Password");
        //Taponbutton(login_obj.Login_Email_Xpath);
        TaponbuttonaccessabilityID(login_obj.Login_Email);
        Thread.sleep(1000);
        cleartext(login_obj.Login_Email_Xpath);
        //entertext(login_obj.invaliduser1,login_obj.Login_Email_Xpath);
        entertextaccessabilityId(login_obj.SDB_Marine_user_pwd,login_obj.Login_Email);
        driver.executeScript("mobile: performEditorAction", ImmutableMap.of("action", "search"));

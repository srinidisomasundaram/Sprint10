Feature: Testing an Dometic LMC application
  ...
  @sanity1
  Scenario: Verifying application German Language AC MODE in  Klima screen
  ...
  @sanity1
  Scenario: Verifying application German Language AC Lüftergeschwindigkeit in  Klima screen
  ...
  @sanity1
  Scenario: Verifying application German Language Heizung in  Klima screen
  ...
  @sanity1
  Scenario: Verifying application German Language Heißwasserstand in  Klima screen
  ...
  @sanity1
  Scenario: Verifying application German Language Energie in  Klima screen
